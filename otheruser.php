...
<?php
	...
	$sql="SELECT * FROM `registration` WHERE `usr_id`='".$myid."'";
...
<div class="col-lg-8">
	 <div class="col-lg-12">
           <div class="panel panel-default">
           <div class="panel-heading"><h2 class="text-left text-primary"> Technical Skill</h2></div>
		<form method="post">
	<textarea name="skill" rows='5' cols="150" style="width:100%" placeholder="Enter Your Skills...e.g.PHP,Java" ><?php echo $row['skill']; ?></textarea>
</div>
<hr/>
 ...
 <div class="panel panel-default">
           <div class="panel-heading"><h1 class="text-left text-primary">Experience</h1></div>
           
<input type="text" name="experience" placeholder="Enter Your Experience" value="<?php echo $row['experience']; ?>">
</div>
<div class="panel-heading"><h1 class="text-left text-primary"><a href="" download>Download Resume</h1></div>
         
</button>
</div>

<label>Projects :</label><br>
<textarea name="project" rows='4' cols="100"  placeholder="Enter your Details about your proejcts here"><?php echo $row['project']; ?></textarea>
<BR/><BR>
