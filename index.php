	...
	<div class="sixteen columns">
		...
		<nav id="navigation" class="menu">
			<ul id="responsive">
				...
				<li><a data-toggle = "modal" data-target = "#myModal" id="current">Hire</a>
					
				</li>
				<li><a href="questions.html" data-toggle = "modal" data-target = "#myModal" id="current">sample questions</a></li>
	...
	<div class="container">
		<div class="footer-bottom">
			<div class="sixteen columns">
				...
				<div class="copyrights">©  Copyright 2019 by <a href="#">Sayantan Halder</a>. All Rights Reserved.</div>
			</div>
		</div>
	</div>
