...
$resume=$_POST["myFile"];
$resume1=$_FILES["myFile"]["name"];
$tmp=$_FILES["myFile"]["tmp_name"];
$type=$_FILES["myFile"]["type"];

$path="resume/".$resume1;
$sql=mysqli_query($con,"UPDATE REGISTRATION SET skill='".$skill."',experience='".$experience."',project='".$project."',Resume='".$resume."' where name='".$_SESSION['name']."'");
if($sql)
		{  
...
<input type="file" name="myFile" multiple><br><?php echo $res['Resume']; ?>
<BR/><BR>
